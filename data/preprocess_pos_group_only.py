...
import json
from .preprocess import get_catnm_list
...
if __name__ == '__main__':
    ...
    preprocess(opt.data_root, 'train_set.csv', 'train_set_pos_only_group.json', fg_id_to_catnm, bg_catnm_idset)
    preprocess(opt.data_root, 'test_set.csv', 'test_set_pos_only_group.json', fg_id_to_catnm, bg_catnm_idset)