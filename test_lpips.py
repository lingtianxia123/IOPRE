...
def get_args_parser():
    ...
    # Test
    parser.add_argument('--num_select', default=10, type=int, help='the number of predictions selected for evaluation')
    ...
    parser.add_argument('--test_type', default='test_pos_only', type=str)
